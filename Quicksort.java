...
public class Quicksort {
    ...
    public static void main(String[] args) {
        ...
        int numRuns = 2;
        List<PivotSelector> selectors = Arrays.asList(new FirstIndexPivotSelector(), new RandomPivotSelector());
        List<String> names = Arrays.asList("First index", "Random index");
